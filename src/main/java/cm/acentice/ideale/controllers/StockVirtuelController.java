...
public class StockVirtuelController {
    ...
    public StockVirtuelDto create(@RequestBody StockVirtuelDto stockVirtuelDto) throws ResourceNotFoundException {

        return stockVirtuelService.create(stockVirtuelDto);
    }
}
